...
const scriptURL = 'https://script.google.com/macros/s/AKfycbwOrSgwP1hxrgAK4cvRK2RAlKM7bpjNg8mNQeMLUasKFYowdEZS110M5WJ4f6dOuhDXsg/exec';
  ...
  fetch(scriptURL, { method: 'POST', body: formData })
    .then(response => {
      if (response.ok) {
        ...
        const redirectURL = `https://research.sc/participant/login/dynamic/D09326CC-E027-40D0-9424-8567DA5EC9C3?response_id=${responseID}`; // URL TO TESTING PROJECT!
